          ...
          <div className="grid grid-cols-2 gap-x-6 lg:gap-y-36 gap-y-8">
            <div className="bg-[#F4F3FF] p-8 rounded-xl gap-10 flex flex-col justify-between col-span-2 lg:col-span-1">
              <div>
                ...
                <p className="text-lg">
                  We support Marketing Agencies and Resellers. Contact us to
                  find out how we can provide your clients with industry leading
                  press.
                </p>
              </div>
            ...
            <div className="bg-[#FFF6ED] p-8 rounded-xl gap-10 flex flex-col justify-between col-span-2 lg:col-span-1">
              <div>
                ...
                <p className="text-lg">
                  Save up to 30% on bulk orders. Our discounts start from just
                  five orders.
                </p>
              </div>
              <div>
            ...
            <div className="bg-[#ECFDF3] lg:py-20 py-8 lg:px-12 px-3 rounded-xl gap-10 flex lg:flex-row flex-col justify-between col-span-2">
              <div>
                <figure className="lg:max-h-60 flex-col justify-end hidden lg:flex">
                  <Image
                    src="https://res.cloudinary.com/dbhgrickp/image/upload/v1703494253/Easy-pr/discount_ptn284.png"
                    height={600}
                    width={600}
                    alt="discount image"
                    className="lg:scale-125 relative lg:top-8"
                  />
                </figure>
              </div>
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xl">
                    In the event that we cannot publish your news story on the
                    news outlets included in your chosen news network, you will
