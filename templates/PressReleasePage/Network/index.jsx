...
export default function Network({ network, outlet }) {
  ...
  //www.msn.com/en-us/money/other/uxlink-unveils-revolutionary-features-for-web3-asset-management-announces-partnership-with-okx-wallet/ar-BB1hA7tF
  https: return (
    <>
              ...
              <TabPanel key={index}>
                <div className="max-w-4xl mx-auto mt-4">
                  ...
                  <div className="bg-white mt-8 lg:mt-4 lg:rounded-full grid lg:grid-cols-4 grid-cols-2 lg:gap-20 gap-6 py-6 lg:px-16 px-3 justify-center text-center">
                    <div>
                      <strong className="lg:text-[36px] text-3xl text-gray-900 block">
