						...
						<div className='flex flex-col gap-12 '>
							<div>
								<div className='flex flex-col lg:flex-row gap-2 items-center'>
									...
									<div>
										<div className='text-primary-300 border border-primary-300 bg-primary-50 rounded-full py-1.5 px-5 flex gap-1 items-center'>
											<RiVipCrownLine height={18} />{' '}
											<h1 className='text-base text-inherit mb-0'>
												{hero?.section.name}
											</h1>
										</div>
									</div>
